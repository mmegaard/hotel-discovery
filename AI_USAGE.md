...
- **I decided:** native range inputs over a library; commit-on-blur for typed values; keep stale results while
  refreshing rather than flashing skeletons; no debounce.
- **I changed:** reviewed the PR before merge.
